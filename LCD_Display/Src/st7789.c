...
void ST7789_SetRotation(uint8_t m)
{
    ...
    switch(m)
    {
        ...
        case 1: // Landscape
            ST7789_WriteSmallData(ST7789_MADCTL_MV | ST7789_MADCTL_MX | ST7789_MADCTL_RGB);
            break;
        ...
        case 3: // Landscape (inverted)
            ST7789_WriteSmallData(ST7789_MADCTL_MV | ST7789_MADCTL_MY | ST7789_MADCTL_RGB);
            break;
    }
}
...
void ST7789_Init(void)
{
	...
	HAL_Delay(130); //TO_BE_REVISITED
  	ST7789_WriteCommand (ST7789_NORON);		//	Normal Display on
  	ST7789_WriteCommand (ST7789_DISPON);	//	Main screen turned on	

	HAL_Delay(50);
	ST7789_Fill_Color(BLACK);				//	Fill with Black.
//	ST7789_DrawRectangle(0, 0, 133, 238, YELLOW);
//	HAL_Delay(5000);
}
...
{
    uint16_t i;
    uint16_t data[ST7789_WIDTH][ST7789_HEIGHT];

    ST7789_SetAddressWindow(0, 0, ST7789_WIDTH+1, ST7789_HEIGHT);
    ST7789_Select();
...
void ST7789_Test(void)
{
	...
	HAL_Delay(1000);
	ST7789_WriteString(10, 20, "Speedo Test", Font_11x18, RED, WHITE);
	HAL_Delay(1000);
